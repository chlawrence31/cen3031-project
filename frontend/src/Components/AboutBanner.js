...
const AboutBanner = () => {
    ...
    const welcomeMessage = {
      content: "A Sanctuary for the Voiceless, A Movement for Change",
      style: {
        fontSize: '40px',
        fontFamily: 'Copperplate, serif',
        marginTop: '0px',
    ...
    return (
        <Carousel prevIcon={null} nextIcon={null}>
            <Carousel.Item>
                ...
                src="https://images.unsplash.com/photo-1709506388643-b7ad803aafe1?q=80&w=1975&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
